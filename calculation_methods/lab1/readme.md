...
- Проделать сто раз пункты 1-7 и вывести отчёт в формате .txt. В отчет должно входить:
    ...
    - [ ] Максимальное, среднее и минимальное количество итераций метода релаксации, необходимых для получения
      приближенного решения.
- [ ] Выполнить пункты 2-7 для матриц 𝐴1и 𝐴2.
- [ ] Для 𝐴2 и матрицы с максимальным числом обусловленности из пункта 8:
    - [ ] исследовать (путём решения нескольких СЛАУ) влияние возмущения вектора 𝑏 на погрешность полученного решения
